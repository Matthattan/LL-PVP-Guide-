<template>
  ...
  <main>
    ...
    <br>
    <p>This website is a Single-Page Application meaning refreshing your browser will bring you back to this page, the Index. This may change in the future but for now, be aware if you're doing some deep research.
